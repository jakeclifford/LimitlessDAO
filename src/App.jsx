...
const App = () => {
  ...
  const mintNft = () => {
    ...
    .finally(() => {
      setIsClaiming(false);
      setHasClaimedNFT(true);
      console.log(`Successfully Minted! Check it out on OpenSea: https://testnets.opensea.io/assets/0xd79d7fb7a31dc6daa61fb31daf367241bb1947b7/0`)
    })
  }

  return (
    <div className="landing">
      <h1>Become Limitless, Mint your Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => mintNft()}
      >
